...
public:
     ...
     * @param employmentStatus The employment status (true for employed, false for unemployed).
     */
    virtual bool getEmplymentStatus() {} ; 
     ...
     * @param employmentStatus The ownership status (true for employed, false for unemployed).
     */
    virtual bool getPropertyOwnershipStatus() {} ; 
